...
const config: Config = {
  ...
  tagline: 'Master the convergence of AI and robotics',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Physical AI & Humanoid Robotics. Built with ❤️ by Muhammad Jibran Rehan.`,
    },
    prism: {
